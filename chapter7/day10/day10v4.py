...
lickWords = [
    ...
    "在人流中，我一眼就发现了你。我不敢说你是你们中最漂亮的一个，可是我敢说，你是你们中最出色的一个。",
    ...
    "清澈明亮的瞳孔，弯弯的柳眉，长长的睫毛微微地颤动着，白皙无瑕的皮肤透出淡淡红粉，薄薄的双唇如玫瑰花般娇嫩欲滴。",
    ...
    "若说你年纪轻轻，怎生得如此身段，且有一张勾魂摄魄的俏脸。",
    "那眼神优雅、娴静，双眼回盼流波，像是俏丽的江南女子;但又挂着一丝倔犟的波纹，又带着北国女儿的神韵。",
    "清水出芙蓉，天然去雕饰。——李白",
    "同样是美女，这个女孩给人最深刻的印象是你眉宇之间有种超越了你年龄的惊人的美丽，淡淡的柳眉分明仔细的修饰过，长长的睫毛忽闪忽闪的象两把小刷子，亮得让人觉得刺目的一双漂亮到心悸的大眼睛，异常的灵动有神。",
    ...
    "皓腕胜雪，乌发如云，你的眼眸水光潋滟、媚眼如丝，一双勾魂的眼，只一眼，就完全沉溺其中不可自拔。高挺鼻子下的那张玫色小嘴微微张着，如同妖艳的玫瑰。你的面容如娇嫩清雅，犹如杯中之莲，绝色之姿灵气逼人。那美，用怎样的辞藻来形容都是苍白而无力，真是只可意会，不可言传。你静若处子，似不食人间烟火，动若脱兔，眉间微存的稚气带着无比的灵动。",
    "世上美人众多，肥环燕瘦，无一人有你那样独特的气质。孤傲、无畏、自信、有着一股不羁的野性，你是最璀璨的光华结晶，如同一团烈火，激烈且张狂地燃烧着。你让美丽不再只是容貌上，而是由心真正的散发出来，你紧抓着众人的眼。再加之，一袭冰蚕丝纱裙所衬托出的空灵气质，与在阳光照射下而形成的淡淡光晕，更若天女下凡，绝美无双!",
    ...
    "你那双大大的眼睛，闪烁着聪颖的光辉，像两颗朗朗的星星。",
    "你和你的哥哥一样，生就一副绝顶聪明的头脑，心灵得像窗纸，一点就透。",
    "聪明的人不是具有广博知识的人，而是掌握了有用知识的人。",
    "他那双乌黑晶亮的眼睛，骨碌碌地打转，显得很机灵懂事。",
    "别看他人小，心眼可灵啦，",
    "10个大人也比不上他，真是秤砣虽小能吊千斤。",
    "他是个聪明的孩子，精灵得像个小猴儿。",
    "别看阿墩胖得肥肉直打颤颤，动作却机警得像只与猎人周旋的豹子。",
    "你那双圆溜溜的大眼睛，镶了一圈乌黑闪亮的长睫毛，眨动之间，透出一股聪明伶俐劲儿。",
...
# 对前面的列表进行处理：
"""
for lick_sentence in lickWords[:5]:
    print(lick_sentence)
"""
# 只要用户没有输入q，程序会一直循环输出彩虹屁
""" # 生成第一个随机数
...
# 下来要开始写循环
while True:
    serialNumber = random.randint(0, 100)
    print(lickWords[serialNumber], end="\n")
    active = input('怎么样，听得开心吗？我继续了哦！')
    if active.lower() == 'q':
        break
    else:
        continue
